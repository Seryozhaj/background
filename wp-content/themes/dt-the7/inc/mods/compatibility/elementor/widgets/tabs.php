...
use Elementor\Controls_Manager;use Elementor\Core\Kits\Documents\Tabs\Global_Typography;use Elementor\Core\Responsive\Responsive;use Elementor\Group_Control_Box_Shadow;use Elementor\Group_Control_Typography;use Elementor\Icons_Manager;use Elementor\Repeater;use The7\Mods\Compatibility\Elementor\Pro\Modules\Dynamic_Tags\The7\Module as TagsModule;use The7\Mods\Compatibility\Elementor\The7_Elementor_Widget_Base;
	...
	protected function add_icon_styles() {
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors_dictionary' => [
					...
					'right' => 'flex-flow: row-reverse nowrap;',
				],
				'selectors'            => [
					'{{WRAPPER}} .the7-e-tab-title' => '{{VALUE}}',
					'{{WRAPPER}}.icon-align-top .the7-e-tab-title > .elementor-icon' => 'text-align: center;',
					'(tablet) {{WRAPPER}}.icon-align-tablet-top .the7-e-tab-title > .elementor-icon' => 'text-align: center;',
					'(mobile) {{WRAPPER}}.icon-align-mobile-top .the7-e-tab-title > .elementor-icon' => 'text-align: center;',
				],
				'prefix_class'         => 'icon-align%s-',
				'default'              => 'left',
				'toggle'               => false,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.icon-align-top .the7-e-tab-title > .elementor-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'(tablet) {{WRAPPER}}.icon-align-tablet-top .the7-e-tab-title > .elementor-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'(mobile) {{WRAPPER}}.icon-align-mobile-top .the7-e-tab-title > .elementor-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',

					'{{WRAPPER}}.icon-align-left .the7-e-tab-title > .elementor-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'(tablet) {{WRAPPER}}.icon-align-tablet-left .the7-e-tab-title > .elementor-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'(mobile) {{WRAPPER}}.icon-align-mobile-left .the7-e-tab-title > .elementor-icon' => 'margin-right: {{SIZE}}{{UNIT}};',

					'{{WRAPPER}}.icon-align-right .the7-e-tab-title > .elementor-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '(tablet) {{WRAPPER}}.icon-align-tablet-right .the7-e-tab-title > .elementor-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
					'(mobile) {{WRAPPER}}.icon-align-mobile-right .the7-e-tab-title > .elementor-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
