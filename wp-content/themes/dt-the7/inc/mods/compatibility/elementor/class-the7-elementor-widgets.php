...
class The7_Elementor_Widgets {
	...
	public function register_assets() {
		...
		the7_register_style(
			'the7-horizontal-menu-widget',
			PRESSCORE_THEME_URI . '/css/compatibility/elementor/the7-horizontal-menu-widget'
		);
		...
		the7_register_script_in_footer(
			...
			PRESSCORE_ADMIN_URI . '/assets/js/elementor/frontend-common.js',
			[ 'dt-main' ]
		);
